...
function productoMenorValor($inv){
    $menorValor = 0;
    $productoMenor = "";
    foreach($inv as $producto => $info){
        $valorActual = $info['cantidad'] * $info['precio'];
        if($valorActual < $menorValor || $menorValor === 0){
...
$productoMenor = productoMenorValor($inventario);
echo "El producto con mayor valor en inventario es '{$productoMayor['producto']}' con un valor total de $" . $productoMayor['valor'] . "\n";
echo "El producto con menor valor en inventario es '{$productoMenor['producto']}' con un valor total de $" . $productoMenor['valor'] . "\n";