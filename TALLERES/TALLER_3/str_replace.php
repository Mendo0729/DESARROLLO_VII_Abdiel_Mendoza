...
$miFrase = "Todo programador usa PHP"; // Reemplaza esto con tu frase
...
$texto = "Fresas y naranjas son frutas. Me gustan las manzanas y las naranjas.";
$buscar = ["Manzanas", "naranjas"];
$reemplazar = ["Peras", "mandarinas"];
