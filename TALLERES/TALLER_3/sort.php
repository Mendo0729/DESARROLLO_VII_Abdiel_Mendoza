...
$palabras = ["PHP", "JavaScript", "Python", "SQL", "C++", "Rust"];
...
$estudiantes = [
    ["nombre" => "Juan", "edad" => 20, "promedio" => 9.0],
    ["nombre" => "María", "edad" => 22, "promedio" => 9.5],
    ["nombre" => "Carlos", "edad" => 19, "promedio" => 9.0],
    ["nombre" => "Ana", "edad" => 21, "promedio" => 9.5],
    ["nombre" => "Luis", "edad" => 23, "promedio" => 8.8]
];
...
echo "<h3>Estudiantes ordenados:</h3>";
foreach ($estudiantes as $e) {
    echo "{$e['nombre']} - Promedio: {$e['promedio']}, Edad: {$e['edad']}<br>";
}
